                    ...
                    return (
                        <>
                            <li key={element.name} className={`w-[90%] flex justify-between bg-gray-100 border border-gray-200 shadow-md rounded-md px-4 py-2`} >
                                {element.name}
                                <div key={element.name} className="w-fit flex gap-2 items-center text-sm h-fit font-medium text-blue-400">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="fill-blue-400" height="16" width="18" viewBox="0 0 576 512">
